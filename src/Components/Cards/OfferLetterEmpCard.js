      ...
      <View style={styles.cardHeaderSection}>
        <View style={styles.cardHeader}>
          ...
          <View>
            ...
            <Text style={styles.seekerDate}>{offerLetter?.job_title || 'Job Applicant'}</Text>
          </View>
        </View>
        <View
          style={[
            ...
            {
              backgroundColor: offerLetter?.application_status?.includes('Accepted')
                ? '#DFFAF6'
                : offerLetter?.application_status?.includes('Rejected')
                ? Colors.secondaryRed
        ...
        >
          ...
          <Text
            style={[
              styles.status,
              offerLetter?.application_status?.includes('Accepted')
                ? styles.accepted
                : offerLetter?.application_status?.includes('Rejected')
                ? styles.rejected
                : styles.pending,
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            navigation.navigate('PdfViewer', {
              pdfUrl: offerLetterData?.offer_letter,
              fileName: offerLetterData?.offer_letter,
            });
          }}
        >
          <Text style={styles.buttonText}>View Offer Letter</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
