  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Discover by phone</Text>
      </View>

      {/* Description */}
      <Text style={styles.description}>
        Who can discover your profile, if they have your Phone Number?
      </Text>
...
export default DiscoverbyPhone;
